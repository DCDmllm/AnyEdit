...
from uniformer.mmcv.cnn import CONV_LAYERS, ConvAWS2d, constant_init
from uniformer.mmcv.ops.deform_conv import deform_conv2d
from uniformer.mmcv.utils import TORCH_VERSION, digit_version
